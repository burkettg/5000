//: Object/test/LegalRollTest.java
package test;
...
public class LegalRollTest {
	...
	case 1: System.out.println("num of Die: " + numRolled + " die1: " + result1); 
			testDie(result1); break;
	case 2: System.out.println("num of Die: " + numRolled + " die1: " + result1 + " die2: " + result2); 
			testDie(result1, result2); break;
	case 3: System.out.println("num of Die: " + numRolled + " die1: " + result1 + " die2: " + result2 + " die3: " + result3); 
			testDie(result1, result2, result3); break;
	case 4: System.out.println("num of Die: " + numRolled + " die1: " + result1 + " die2: " + result2 + " die3: " + result3 + " die4: " + result4); 
			testDie(result1, result2, result3, result4); break;
	case 5: System.out.println("num of Die: " + numRolled + " die1: " + result1 + " die2: " + result2 + " die3: " + result3 + " die4: " + result4 + " die5: " + result5); 
			testDie(result1, result2, result3, result4, result5); break;
	default:System.out.println("Who knows what happened..  Stopped before implementing legal roll testDie()"); 
	}
	}
	
	private void testDie(int result1) {
		res1 = result1;
		if( res1 == 1 ) {System.out.println("valid"); }
		else if( res1 == 5) {System.out.println("valid");}
		else {System.out.println(" is not a valid roll.  BUNK!");}
	}
	
	private void testDie(int result1, int result2) {
		res1 = result1;res2 = result2;
		if ( (!(res1 == 1) && !(res1 == 5)) && ( ( !(res2 == 1) && !(res2 == 5)))  )  {System.out.println("valid"); } 
		else {System.out.println(" is not a valid roll.  BUNK!");}
	}
	
	private void testDie(int result1, int result2, int result3) {
		res1 = result1;res2 = result2;res3 = result3;
		if ( (!(res1 == 1) && !(res1 == 5)) && ( ( !(res2 == 1) && !(res2 == 5))) && ( ( !(res3 == 1) && !(res3 == 5)))
			&& ( !(res1 == res2) || !(res1 == res3) || !(res2 == res3) ) ){System.out.println("valid"); }
		else {System.out.println(" is not a valid roll.  BUNK!");}
	}
	
	private void testDie(int result1, int result2, int result3, int result4) {
	...
	private void testDie(int result1, int result2, int result3, int result4, int result5) {
